...
INSERT INTO `builder` VALUES (1,'Frank Lawne Builders','Ard Chicken','','Donegal Town','Donegal',867981654,'frank.lawne@builders.ie'),(2,'Paddy Doherty','Bridge Street',NULL,'Kilcar','Donegal',874545454,'paddydoh@builder.ie'),(3,'Seán MacSuibhne','Old Road',NULL,'Carrick','Donegal',875959595,'seanmac@builder.ie');
