...
public class ExternalTab extends JPanel {
	...
	public ExternalTab() {
		...
		externalPanel.setBorder(new TitledBorder(new EtchedBorder(
				EtchedBorder.LOWERED, null, null), "External Options",
		...
		gbl_externalPanel.columnWeights = new double[] { 0.0, 0.0,
				Double.MIN_VALUE };
		gbl_externalPanel.rowWeights = new double[] { 0.0, 0.0, 0.0, 0.0,
				Double.MIN_VALUE };
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JobScreen.resetLowerPanes();
				JobScreen.pavingBedCalc.setVisible(true);
			}
		});
